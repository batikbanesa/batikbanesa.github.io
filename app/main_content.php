        ...
        <div class="col s12 m6 l3 me-sl">
            <div class="card">
                <div class="card-content dash-nav-box">
                    ...
                    <p class="dash-nav-body"><i class="material-icons text-teal">supervisor_account</i><span></span></p>
        ...
        <div class="col s12 m6 l3 me-sl">
            <div class="card">
                <div class="card-content dash-nav-box">
                    ...
                    <p class="dash-nav-body"><i class="material-icons text-green">group_work</i><span></span></p>
                    <p class="dash-nav-footer">Dari Update Terakhir</p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l3 me-sl">
            <div class="card">
                <div class="card-content dash-nav-box">
                    ...
                    <p class="dash-nav-body"><i class="material-icons text-pink">monetization_on</i><span></span></p>
                    <p class="dash-nav-footer">Dari Update Terakhir</p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l3 me-sl">
            <div class="card">
                <div class="card-content dash-nav-box">
                    ...
                    <p class="dash-nav-body"><i class="material-icons text-deep-purple">shopping_cart</i><span></span></p>
                    <p class="dash-nav-footer">Dari Update Terakhir</p>
                </div>
            </div>
        </div>
